<template>
    <div @scroll.native="handlerScroll">
        ...
        <div class="container">
            {{slogan}}
            <div id="scrollTop" v-if="showB">她愿意和你说这么多,则说明她并不讨厌你,并且当你是朋友!她没有答应你是因为她心里很矛盾,她不知自己是否该答应你,或许是因为还不太了解你,怕自己受到伤害!你应该继续下去,别老是乎冷乎热,她说过时间会证明一切,这是在考验你说的话!其次不可心急,可以看出这是个很单纯的女孩子,或许还是初恋,她想要的是一份很甜蜜的恋爱!她叫你傻瓜证明她开始在意你了,你很有机会!可以收买她的死党,但是千万别妄想很快追到她,这或许是一场持久战!毕竟好女孩不容易追嘛!你就象之前那样对她好,别刻意去展现对她的好,切记!还有不要写情书,可以发短信,发些笑话或可爱的脑筋急转弯,不要发黄段子!一点一点积累她对你的感觉,但是自己一定要有衡心!如果只是想玩玩人家那我劝你还是别去伤害人家了!既然是真心喜欢就一直执着下去,没有过不了的河!时间会宣布一切,别去想她最后会拒绝你,要有必胜的决心!至于生日礼物你可以去石头记看看,那里面卖的都是女孩子喜欢的!可以找服务员推荐下! 最后祝你成功!希望这些话能对你有启发!</div>
        </div>
        <div id="up" @click="backTop">返回顶部</div>
    </div>
</template>
